        ...
        <div class="container">
            <form id="form-work" class="" name="form-work" action="ControllerPermiso" method="get">
                ...
                <div class="form-group" >  
                    ...
                    <input type="hidden" name="id" value="<%= permiso.getId_permido()%>">
                    <div class="col-md-3">
                        <label class="control-label" for="Id_modulo">Id modulo</label>
                        <input name="Id_modulo" class="form-control" placeholder="Id_modulo" type="text" value ="<%= permiso.getId_modulo()%>">
                    </div>
                    <br><br><br>
                    <div class="col-md-3">
                        <label class="control-label" for="getId_rol">Id rol</label>
                        <input name="getId_rol" class="form-control" placeholder="getId_rol" type="text" value ="<%= permiso.getId_rol()%>">
                    </div>
                    <br><br><br>
                    <div class="col-md-3">
                        <label class="control-label" for="Fecha Creacion">Fecha Creacion</label>
                        <input name="password" class="form-control" placeholder="Fecha Creacion" type="text" value="<%= permiso.getFecha_crea()%>">
                    </div>
                    <br><br><br>
                    <div class="col-md-3">
                        <label class="control-label" for="Usuario Creacion">Usuario Creacion</label>
                        <input name="password" class="form-control" placeholder="Usuario Creacion" type="text" value="<%= permiso.getUsuario_crea()%>">
                    </div>
                    <br><br><br>
                    <div class="col-md-3">
                        <label class="control-label" for="Fecha Modifica">Fecha Modifica</label>
                        <input name="password" class="form-control" placeholder="Fecha Modifica" type="text" value="<%= permiso.getFecha_mod()%>">
                    </div>
                    <br><br><br>
                    <div class="col-md-3">
                        <label class="control-label" for="Usuario Modifica">Usuario Modifica</label>
                        <input name="password" class="form-control" placeholder="Usuario Modifica" type="text" value="<%= permiso.getUsuario_mod()%>">
                    </div>
                    <br><br><br>
                    <div class="col-md-3">
